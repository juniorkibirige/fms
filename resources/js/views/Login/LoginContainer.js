    ...
    render() {
        ...
        return (
            <>
                ...
                <div className='header py-7 py-lg-8 col-lg-12 col-12' style={{
                    backgroundImage: `url('argon/img/brand/bg-01.jpg')`,
                    backgroundColor: `rgba(25, 25, 25, 0.9)`,
                    backgroundBlendMode: `soft-light`
                }}>
                    <div className='container'>
                        <div className='row'>
                            <div style={{borderRadius: `5px`, paddingTop: `3rem`, paddingBottom: `3rem`}}
                                 className=" ml-sm-7 bg-secondary offset-xl-2 col-xl-4 offset-lg-2 col-lg-7 offset-md-0 col-md-12 offset-0 col-sm-12 col-12">
...

                                {
                                    this.state.isLoggedIn
                                        ? <FlashMessage duration={60000} persistOnHover={true}>
                                            <h5 className={"alert alert-success text-center"}>Login successful,
                                                redirecting...</h5>
                                        </FlashMessage>
                                        : ''
                                }
                                ...
                                <form onSubmit={this.handleSubmit}>
                                            ...
                                            <div className="input-group mb-4">
                                                <div className="input-group-prepend" style={{height: `2rem`}}>
                                                    <span className="input-group-text"
                                                          style={{backgroundColor: `#cdd4d9`}}>
                                                        <i className="ni ni-single-02 text-black"></i>
                                                    </span>
                                                </div>
                                                <input name="email" onChange={this.handleFieldChange} required
                                                       className="form-control pl-3" placeholder="Username or Email"
                                                       type="text" style={{borderColor: `#cad1d7`, height: `2rem`}}/>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-12">
                                        <div className="form-group">
                                            <div className="input-group mb-4">
                                                ...
                                                <input name="password" onChange={this.handleFieldChange} required
                                                       className="form-control pl-3" placeholder="Password"
                                                       type="password"
                                                       style={{borderColor: `#cad1d7`, height: `2rem`}}/>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                    ...
                                    <div className='mt-2 text-center'>
                                        <Button type='submit' name='singlebutton' disabled={this.state.formSubmitting}
                                                className='btn btn-sm text-white px-5'
                                                style={{backgroundColor: `#570f75`}}> {this.state.formSubmitting ? "Logging you in ... " : "Login"}</Button>
                                    </div>
                            ...
                            <div style={{borderRadius: `7px`, marginLeft: `10em !important`}}
                                 className="text-center p-lg-5 p-md-4 pt-sm-7 ml-7 offset-xl-1 col-xl-4 offset-lg-1 d-none d-sm-none d-md-block col-lg-7 offset-md-0 col-md-12 offset-0 col-sm-12 col-12">

                                <Link className='root' to='/'>
                                    <img src={Logo} className='d-block mx-auto mt-4'
                                         style={{width: `150px`, height: `120px`, marginTop: `100px`}}/>
                                </Link>
