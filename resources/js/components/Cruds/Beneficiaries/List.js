                            ...
                            <ToolkitProvider
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        headerClasses: 'col-md-2 col-sm-3 col-auto',
                                        sort: true,
                                    },
                                    {
                                        dataField: 'NIN',
                                        text: 'NIN',
                                        hidden: false,
                                        classes: 'col-md-auto d-md-table-cell d-none',
                                        headerClasses: 'col-md-auto d-md-table-cell d-none',
                                    },
                                    {
                                        dataField: 'phone_number',
                                        text: 'Phone No.',
                                        hidden: false,
                                        classes: 'col-md-auto col-sm-auto d-md-table-cell d-sm-table-cell d-none',
                                        headerClasses: 'col-md-auto col-sm-auto d-md-table-cell d-sm-table-cell d-none',
                                    },
                                    {
                                        dataField: 'region',
                                        text: 'Region',
                                    ...
                                    },
                                    {
                                        dataField: 'actions',
                                        isDummyField: true,
                                        classes: 'col-md-auto col-sm-auto col-auto',
                                        headerClasses: 'col-md-auto col-sm-auto col-auto',
                                        text: 'Actions',
                                        hidden: false,
