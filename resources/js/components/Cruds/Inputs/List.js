            ...
            <>
                ...
                <div className='header' style={{minHeight: `100%`}}>
                    <div className='container-fluid pt-4 pb-2'>
                        <span className="text-2xl text-capitalize">Inputs</span>
                            ...
                            <ToolkitProvider
                                ...
                                columns={[
                                    ...
                                    },
                                    {
                                        ...
                                        text: 'Name',
                                        hidden: false,
                                        classes: 'col-lg-2 col-md-2 col-sm-3 col-auto',
                                        headerClasses: 'col-lg-2 col-md-2 col-sm-3 col-auto',
                                        sort: true,
                                    },
                                    {
                                        dataField: 'type',
                                    ...
                                    },
                                    {
                                        dataField: 'actions',
                                        isDummyField: true,
                                        classes: 'col-lg-1 col-md-2 col-sm-3 col-auto',
                                        headerClasses: 'col-lg-1 col-md-2 col-sm-2 col-auto',
                                        text: 'Actions',
                                        hidden: false,
